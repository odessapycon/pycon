export const MainSpeakers2020Ru = [

    {
        ...
        rept : [
            {
                title : 'Дважды датасаенсим задачу: как получилось и как нужно [Ua]',
                description :
                    '<p>Нам нужно было разобраться, в каком научном журнале была опубликована каждая из десятков миллионов статей. ' +
                    'Решаем задачу, потом узнаём, что мир не такой, каким кажется, используем научный подход вместо ' +
                    'ковбойского и получаем от этого профит.</p>'
            }
        ],
        aboutSpeaker : '',
        socialsRendered : '',
    ...
    },
    {
        ...
        rept : [
            {
                title : 'Word Embeddings в Python от word2vec до BERT. Фишки и особенности работы на проде [Ru]',
                description :
                    '<p>Мы поговорим про библиотеки и предобученные модели для Word Embeddings в Python. ' +
                    'Когда читаешь статьи или описания word2vec, fastText, Bert, etc. этот мир чудесен. ' +
                    'Но, в реальном мире, вы сталкиваетесь с проблемами производительности, утечек памяти и тем, ' +
                    'что оно все норовит отлюбнуть. </br>' +
                    'Так что же вам лучше всего подойдет для ваших задач и как это заставить работать быстро и стабильно?</p>'
            }
        ],
        aboutSpeaker : '',
        socialsRendered : '',
